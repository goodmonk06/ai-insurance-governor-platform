 ...
 */
export type AllDomainEvents = PolicyCreatedEvent | PolicyActivatedEvent | PolicyCancelledEvent | PolicyRenewedEvent | ClaimSubmittedEvent | ClaimApprovedEvent | ClaimDeniedEvent | ClaimPaidEvent | RiskAssessmentCompletedEvent | HighRiskDetectedEvent | QuoteRequestedEvent | QuoteGeneratedEvent | QuoteAcceptedEvent | NotificationSentEvent | NotificationFailedEvent;
/**
